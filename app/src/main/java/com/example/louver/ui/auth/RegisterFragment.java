...
public class RegisterFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        vm.registerState().observe(getViewLifecycleOwner(), state -> {
            ...
            if (state.status == AuthState.Status.ERROR) {
                Snackbar.make(view, state.message != null ? state.message : "Registration failed.", Snackbar.LENGTH_LONG).show();
    ...
    private void attemptRegister() {
        ...
        String confirmStr = textOf(etConfirm);
